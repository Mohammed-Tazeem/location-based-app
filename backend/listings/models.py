...
class Listings(models.Model):
    ...
    choices_listing_types = (
        ("House", "House"),
        ("Apartment", "Apartment"),
        ("Office", "Office"),
    )

    listing_types = models.CharField(max_length=20, choices=choices_listing_types)
    ...
    # use small letter in SRID
    # location = models.PointField(blank=True, null=True, srid=4326)

    # Code to name the listings in Admin Panel
    def __str__(self):
        return self.title
