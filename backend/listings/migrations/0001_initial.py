    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("furnished", models.IntegerField(default=False)),
                ("pool", models.IntegerField(default=False)),
                ("elevator", models.IntegerField(default=False)),
                ("cctv", models.IntegerField(default=False)),
                ("parking", models.IntegerField(default=False)),
                (
                    "date_posted",
